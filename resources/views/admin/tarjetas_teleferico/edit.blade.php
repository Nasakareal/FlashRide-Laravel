@extends('layouts.app')
@section('title','Editar tarjeta teleférico')

@section('content')

<div class="d-flex align-items-center justify-content-between mb-4">
  <div>
    <h1 class="h4 mb-1 fw-black">Editar tarjeta teleférico</h1>
...
<div class="card-soft">
  <div class="p-3 p-lg-4">
    ...
    <form method="POST" action="{{ route('admin.tarjetas-teleferico.update', $tarjetaTeleferico) }}">
      @csrf
      @method('PUT')
